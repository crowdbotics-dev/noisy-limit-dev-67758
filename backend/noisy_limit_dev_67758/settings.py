"""
Django settings for noisy_limit_dev_67758 project.
...
ROOT_URLCONF = 'noisy_limit_dev_67758.urls'
...
WSGI_APPLICATION = 'noisy_limit_dev_67758.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "noisy_limit_dev_67758 API",
    "DESCRIPTION": "API documentation for noisy_limit_dev_67758 App",
    "VERSION": "v1",
}
