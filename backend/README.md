...
## Project Structure
    ...
    ├── noisy_limit_dev_67758  # Django project configurations
...
1. Clone this repo and `cd noisy_limit_dev_67758`
...
2. Clone this repo and `cd noisy_limit_dev_67758`
